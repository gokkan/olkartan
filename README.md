...
Det finns också ett roterbart 3D-läge på `#vy=3d`, där den tredje huvudkomponenten blir djup. Där går de tre riktningarna att välja: en huvudkomponent, en smakklocka, priset eller alkoholhalten på var och en av x, y och z — `#vy=3d&axlar=beska,fyllighet,sötma` ger de tre ölklockorna på varsin axel. Utan valet är molnet kartans egna tre huvudkomponenter, och då betyder avstånd smaklikhet som vanligt. Håller man pekaren över en prick står det vilken dryck det är; att välja något gör man däremot i 2D. Se [PLAN.md](PLAN.md).
